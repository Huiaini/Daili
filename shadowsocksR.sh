...
libsodium_url="https://gitee.com/JoCry/shadowsocksR/raw/master/libsodium-1.0.17.zip"
shadowsocks_r_file="shadowsocksr-3.2.2"
shadowsocks_r_url="https://gitee.com/JoCry/shadowsocksR/raw/master/shadowsocksr-3.2.2.tar.gz"
...
download_files(){
    ...
    if check_sys packageManager yum; then
        if ! wget --no-check-certificate https://gitee.com/JoCry/shadowsocksR/raw/master/shadowsocksR -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download ShadowsocksR chkconfig file!"
            exit 1
        fi
    elif check_sys packageManager apt; then
        if ! wget --no-check-certificate https://gitee.com/JoCry/shadowsocksR/raw/master/shadowsocksR-debian -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download ShadowsocksR chkconfig file!"
            exit 1
        fi
    fi
